...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-kou-21.18-kourovka-notebook-problem-21.18-39ae2d62",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.18-82ad75f603f3",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.18"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Suppose that G is a finite group, and $A_1,A_2,A_3$ are subsets of G such that the multiplication map $A_1\\times A_2\\times A_3\\to G$ is bijective. Must the subgroup $\\langle A_2\\rangle$ generated by $A_2$ have order divisible by the cardinality $|A_2|$?",
      "version": 1
    },
    "title": "Kourovka Notebook Problem 21.18",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "8d17c1b27ee7c87423f21b9b67a70b268b99ef2a9709acb3b288340ac3166c9f"
}
```
